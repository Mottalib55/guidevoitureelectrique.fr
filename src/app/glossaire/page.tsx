...
const glossaire = [
  ...
  { term: "WLTP", description: "Worldwide Harmonized Light Vehicles Test Procédure. Protocole de test standardisé utilisé en Europe pour mesurer la consommation et l'autonomie des véhicules. Plus réaliste que l'ancien cycle NEDC, mais l'autonomie réelle reste souvent inférieure de 10 à 20 %." },
