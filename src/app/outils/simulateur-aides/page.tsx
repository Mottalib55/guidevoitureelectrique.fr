    ...
    <>
      ...
      <article className="section" style={{ paddingTop: 24, paddingBottom: 64 }}>
        ...
        <div className="prose" style={{ marginTop: 48 }}>
          ...
          <p>
            L&apos;État français et les collectivités locales proposent un ensemble d&apos;aides financières pour encourager l&apos;achat de véhicules électriques. Cumulées, ces aides peuvent représenter <strong>5 000 a 14 000 euros de réduction</strong> sur le prix d&apos;un véhicule neuf, voire davantage dans certaines configurations. Mais le système est complexe, avec des conditions d&apos;éligibilité spécifiques à chaque dispositif. Ce guide vous accompagne pas a pas pour identifier toutes les aides auxquelles vous avez droit et maximiser votre soutien financier.
          </p>
          ...
          <p>
            <strong>Attention :</strong> le plafond de 47 000 euros est calcule sur le prix d&apos;achat TTC du véhicule, options comprises. Les frais de mise à la route et la peinture métallisée sont exclus du calcul, mais les équipements de série ou optionnels cochés au configurateur sont inclus. Vérifiez bien que la configuration choisie reste sous le seuil.
          </p>
          ...
          <p>
            La prime à la conversion est une aide supplémentaire accordée lorsque vous mettez au rebut un ancien véhicule polluant pour acheter un véhicule propre. Elle est <strong>cumulable avec le bonus écologique</strong>, ce qui peut significativement réduire le coût d&apos;acquisition.
          </p>

          <h3>Conditions d&apos;éligibilité de l&apos;ancien véhicule</h3>
          <p>
            Pour bénéficier de la prime à la conversion, l&apos;ancien véhicule mis au rebut doit remplir les conditions suivantes :
          </p>
          <ul>
            ...
            <li>Être remis pour destruction a un centre VHU (véhicule hors d&apos;usage) agréé, dans les 3 mois suivant la facturation du véhicule neuf (ou 6 mois précédant)</li>
          </ul>

          <h3>Montants de la prime à la conversion en 2026</h3>
          <p>
            Les montants dépendent de votre revenu fiscal de référence par part :
          </p>
          <ul>
          ...
          <p>
            <strong>Exemple cumul maximal :</strong> Un ménage avec un RFR/part de 12 000 euros, mettant au rebut un véhicule Crit&apos;Air 4, et achetant une Renault 5 E-Tech a 25 000 euros, peut cumuler : bonus écologique de 4 000 euros + prime à la conversion de 3 000 euros = <strong>7 000 euros d&apos;aides</strong>, soit un prix net de 18 000 euros.
          </p>

          <h2>Étape 3 : Le leasing social : pour les ménages modestes</h2>
          <p>
            Le <strong>leasing social</strong> est un dispositif lancé fin 2023 et reconduit en 2025-2026, permettant aux ménages les plus modestes de louer une voiture électrique neuve à partir de <strong>100 euros par mois</strong>. C&apos;est une révolution en termes d&apos;accessibilite à la mobilité électrique.
          </p>
          ...
          <p>
            En 2026, les modèles disponibles en leasing social incluent typiquement : la Citroen e-C3 (des 100 euros/mois), la Renault 5 E-Tech (des 120 euros/mois), la Fiat 500e (des 130 euros/mois) et la Peugeot e-208 (des 140 euros/mois). Les lots sont attribues par vagues, avec un nombre de véhicules limité à chaque session. Il est conseille de se pré-inscrire des l&apos;ouverture des candidatures.
          </p>

          <h2>Étape 4 : Les aides régionales et locales : un complément souvent méconnu</h2>
          <p>
            En plus des aides nationales, de nombreuses régions, départements et métropoles proposent des aides complémentaires. Ces aides sont cumulables avec le bonus écologique et la prime à la conversion, ce qui peut porter le total des aides a des niveaux très significatifs.
          </p>

          <h3>Aides régionales en 2026</h3>
          <ul>
            <li><strong>Île-de-France :</strong> aide de 6 000 euros pour l&apos;achat d&apos;un VE ou d&apos;un véhicule a hydrogène, sous conditions de revenus (RFR/part inférieur a 13 489 euros). Cumulable avec le bonus écologique.</li>
            <li><strong>Grand Est :</strong> prime de 3 000 euros pour l&apos;achat d&apos;un VE neuf, sous conditions de revenus et de lieu de résidence.</li>
            <li><strong>Occitanie :</strong> eco-cheque mobilité de 2 000 a 4 000 euros selon les revenus, pour l&apos;achat ou la location longue durée d&apos;un VE.</li>
            ...
            <li><strong>Auvergne-Rhone-Alpes :</strong> aide de 1 000 a 2 000 euros selon les revenus et le lieu de résidence.</li>
          </ul>
          <p>
          ...
          <ul>
            ...
            <li><strong>Ville de Paris :</strong> aide à la mobilité propre de 400 a 600 euros (en sus des aides Île-de-France)</li>
            <li><strong>Métropole de Grenoble :</strong> prime de 1 500 euros pour les résidents de la ZFE</li>
          ...
          <ul>
            ...
            <li><strong>Aides locales :</strong> certaines collectivités ajoutent une aide supplémentaire (par exemple, la métropole de Lyon propose 500 euros supplémentaires pour l&apos;installation d&apos;une wallbox)</li>
          </ul>

          <h2>Comment cumuler les aides : le récapitulatif</h2>
          <p>
            Voici le cumul maximal théorique pour un ménage très modeste (RFR/part inférieur a 7 700 euros) achetant un VE éligible a moins de 47 000 euros en Île-de-France, avec mise au rebut d&apos;un ancien véhicule Crit&apos;Air 4 :
          </p>
          <ul>
            <li>Bonus écologique : 7 000 euros</li>
            <li>Prime à la conversion : 5 000 euros</li>
            <li>Aide Île-de-France : 6 000 euros</li>
          ...
          <p>
            <strong>Important :</strong> le cumul des aides est soumis à la regle de non-depassement. En aucun cas, le total des aides ne peut dépasser le prix d&apos;achat du véhicule. De plus, certaines aides régionales sont soumises a des conditions spécifiques supplémentaires (résidence dans une ZFE, ancienneté de résidence, etc.). Vérifiez chaque condition auprès de l&apos;organisme concerné avant de compter sur un cumul maximal.
          </p>
          ...
          <ul>
            ...
            <li><strong>Prime à la conversion :</strong> même démarche que le bonus, via le site de l&apos;ASP. Vous devrez fournir le certificat de destruction du véhicule ancien.</li>
            ...
            <li><strong>Aides régionales :</strong> procédures variables selon les régions. Généralement, une demande en ligne sur le site de la région, avec fourniture de pièces justificatives (avis d&apos;imposition, facture du véhicule, carte grise).</li>
            <li><strong>Crédit d&apos;impôt borne :</strong> à déclarer lors de votre déclaration de revenus annuelle, avec la facture de l&apos;installateur.</li>
          </ul>
          <p>
            <strong>Conseil :</strong> conservez soigneusement tous les documents relatifs a l&apos;achat (facture détaillée, carte grise, certificat de conformité, avis d&apos;imposition, justificatif de domicile). Les délais de traitement des aides varient de 1 semaine (bonus avance par le concessionnaire) a 3 mois (aides régionales versées par virement).
          </p>
          <p>
            Notre simulateur ci-dessus vous donne une estimation personnalisée des aides nationales auxquelles vous avez droit. Pour les aides régionales et locales, nous vous invitons à consulter le site de votre région et de votre commune, ou à utiliser le service en ligne de l&apos;ADEME qui centralise progressivement l&apos;ensemble des aides disponibles sur le territoire.
          </p>
        </div>
