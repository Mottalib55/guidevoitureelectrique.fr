          ...
          <div style={{ marginBottom: 28 }}>
            ...
            {vehicule && (
              <p style={{ fontSize: 13, color: "var(--faint)", marginTop: 6 }}>
                Batterie {dec(vehicule.batterieKwh)} kWh, {vehicule.autonomieReelle} km
                d&apos;autonomie réelle, {dec(vehicule.conso)} kWh/100 km
              </p>
            )}
          </div>
        ...
        <div style={{ maxWidth: 720 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                <div>
                  ...
                  <div style={{ fontSize: 12, color: "var(--faint)" }}>
                    Puissance max : {dec(vehicule.chargeRapideKw)} kW
                  </div>
                </div>
                <div>
                  <div style={{ fontSize: 12, fontWeight: 600, color: "var(--faint)", marginBottom: 2 }}>
          ...
          >
            ...
            <ul style={{ marginTop: 8, paddingLeft: 20, lineHeight: 1.8 }}>
              ...
              <li>Essence : {dec(consoThermique)} L/100 km à {prixEssence.toFixed(2).replace('.', ',')} €/L</li>
              <li>Consommation VE : {dec(conso)} kWh/100 km (autonomie réelle)</li>
            </ul>
          </details>
          ...
          <div className="prose" style={{ marginTop: 48 }}>
            ...
            <p>
              En programmant votre recharge exclusivement en heures creuses (facile avec la programmation intégrée de la plupart des VE ou via une wallbox connectée), vous économisez environ 16 % par rapport au tarif Base. Sur notre exemple : (15 000 / 100) x 15 x 0,21 = <strong>472 euros par an</strong>, soit 39 euros par mois. C&apos;est une économie de 90 euros par an par rapport au tarif Base, et de <strong>1 366 euros par rapport à l&apos;essence</strong>.
            </p>
            ...
            <ul>
              ...
              <li><strong>Jours Rouges (22 jours/an) :</strong> environ 0,76 euro/kWh en heures pleines, très cher, à éviter absolument pour la recharge</li>
            </ul>
            <p>
            ...
            <p>
              Au-delà des tarifs réglementés d&apos;EDF, de nombreux fournisseurs alternatifs proposent des offres spécifiques pour la recharge de véhicules électriques. En 2026, les plus compétitives incluent :
            </p>
            <ul>
            ...
            <p>
              Pour recharger a domicile dans les meilleures conditions, l&apos;installation d&apos;une wallbox (borne de recharge domestique) est fortement recommandée. Contrairement à la prise domestique standard (qui limite la charge a 2,3 kW et peut présenter des risques de surchauffe), la wallbox délivre entre 7 et 22 kW en toute sécurité.
            </p>
            <p>
              Le coût d&apos;une wallbox installée varie entre <strong>1 200 et 2 500 euros</strong> selon le modèle, la puissance et la complexité de l&apos;installation. En 2026, un crédit d&apos;impôt de <strong>300 euros</strong> est toujours disponible pour l&apos;installation d&apos;une borne à domicile, et un taux de TVA réduit a 5,5 % s&apos;applique si votre logement a plus de 2 ans.
            </p>
            <p>
              L&apos;investissement dans une wallbox est généralement amorti en 1 a 2 ans grâce aux économies réalisées par rapport à la recharge exclusivement sur bornes publiques. En effet, la différence de prix entre une recharge à domicile (0,21 euro/kWh) et une borne publique (0,35 a 0,45 euro/kWh) représente une économie de 200 a 500 euros par an pour un conducteur moyen.
            </p>

            <h2>Les réseaux de recharge publique : comprendre les tarifs</h2>
            <p>
              Lorsque vous ne pouvez pas recharger à domicile ou lors de vos déplacements, vous utiliserez les bornes de recharge publiques. Le réseau français compte désormais plus de <strong>150 000 points de charge publics</strong> en 2026, mais les tarifs varient considérablement selon le réseau, la puissance et le mode de paiement.
            </p>

            <h3>Recharge AC (courant alternatif) : 7 a 22 kW</h3>
            <p>
              Les bornes AC, les plus répandues, sont adaptées à la recharge &quot;de destination&quot; : parking de supermarché, parking relais, lieu de travail. Comptez généralement :
            </p>
            <ul>
              ...
              <li><strong>Réseaux standards :</strong> entre 0,25 et 0,40 euro/kWh selon l&apos;opérateur et l&apos;abonnement</li>
            ...
            <ul>
              ...
              <li><strong>Réseaux autoroute (Engie, VINCI) :</strong> 0,45 a 0,65 euro/kWh, souvent les plus chers</li>
            </ul>

            <h3>Les cartes et abonnements de recharge multi-réseaux</h3>
            <p>
              Pour éviter de jongler entre les applications de chaque opérateur, les cartes de roaming multi-réseaux donnent accès à la quasi-totalité des bornes en France et en Europe avec un badge unique. Les principales en 2026 :
            </p>
            <ul>
            ...
            <p>
              Ce profil correspond a un usage principalement urbain et périurbain : trajets domicile-travail courts, courses, activités de loisirs locales. Avec la possibilité de recharger à domicile en heures creuses :
            </p>
            <ul>
              <li>Consommation annuelle : (8 000 / 100) x 15 = 1 200 kWh</li>
              <li>90 % à domicile (HC) : 1 080 kWh x 0,21 euro = 227 euros</li>
            ...
            <p>
              Le profil le plus courant en France : trajets domicile-travail de 30 a 40 km quotidiens, avec quelques longs trajets ponctuels. Recharge principalement à domicile :
            </p>
            <ul>
              <li>Consommation annuelle : (15 000 / 100) x 15 = 2 250 kWh</li>
              <li>80 % à domicile (HC) : 1 800 kWh x 0,21 euro = 378 euros</li>
            ...
            <ul>
              ...
              <li>60 % à domicile (HC) : 2 880 kWh x 0,21 euro = 605 euros</li>
            ...
            <p>
              Un facteur souvent sous-estimé est l&apos;impact de la température sur la consommation d&apos;un véhicule électrique. En hiver, la consommation peut augmenter de <strong>20 a 40 %</strong> par rapport à l&apos;été, principalement en raison du chauffage de l&apos;habitacle et de la moindre efficacité de la batterie par temps froid.
            </p>
            <p>
